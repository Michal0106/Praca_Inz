            ...
            <div className="profile-stats">
              <div className="profile-stat">
                ...
                <span
                  ...
                  style={{
                    backgroundColor: getLevelBadgeColor(userProfile.level),
                  }}
                >
                ...
                >
                  ...
                  <div className="plan-meta">
                    <span
                      ...
                      style={{
                        backgroundColor: getLevelBadgeColor(plan.level),
                      }}
                    >
                      {getLevelLabel(plan.level)}
                    </span>
                    <span className="focus-badge">
                      {getFocusLabel(plan.focusType)}
                    </span>
                  </div>
                  <p className="plan-description">{plan.description}</p>
                  <div className="plan-details">
                    <span>
                      <Calendar size={16} /> {plan.durationWeeks} tygodni
                    </span>
                    <span>
                      <Clock size={16} /> {plan.weeklyHours}h/tydzień
                    </span>
                  </div>
                </div>
              ))}
              ...
              {alternativePlans.map((plan) => (
                ...
                >
                  ...
                  <div className="alternative-badges">
                    ...
                    <span className="focus-badge small">
                      {getFocusLabel(plan.focusType)}
                    </span>
                  </div>
                ...
                <div className="info-item">
                  ...
                  <div>
                    ...
                    <div className="info-value">
                      {selectedPlan.durationWeeks} tygodni
                    </div>
                  </div>
                </div>
                <div className="info-item">
                  ...
                  <div>
                    ...
                    <div className="info-value">
                      {selectedPlan.weeklyHours} godzin
                    </div>
                  </div>
                </div>
                <div className="info-item">
                        ...
                        <div className="session-content">
                          ...
                          <div className="session-meta">
                            ...
                            <span
                              ...
                              data-intensity={session.intensity}
                            ></span>
